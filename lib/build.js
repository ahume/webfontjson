...
function buildFontFaceRule(fonts) {
	...
	for (var i = 0, j = fonts.length; i<j; ++i) {
		...
		css += (font['font-weight']) ? 'font-weight:' + font['font-weight'] + ';' : '';
		css += (font['font-style']) ? 'font-style:' + font['font-style'] + ';' : '';
		css += (font['font-stretch']) ? 'font-stretch:' + font['font-stretch'] + ';' : '';
		css += (font['font-variant']) ? 'font-variant:' + font['font-variant'] + ';' : '';
		css += (font['font-feature-settings']) ? 'font-feature-settings:' + font['font-feature-settings'] + ';' : '';
		css += (font['unicode-range']) ? 'unicode-range:' + font['unicode-range'] + ';' : '';
